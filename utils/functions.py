...
def restore_model(model, model_dir):
    ...
    # new
    # output_model_file = '/home/huangyiting2023/TEXTOIR/outputs_un_pre/open_intent_discovery/USNID_stackoverflow_0.75_0.1_1.0_bert_USNID_0/pretrain/pytorch_model.bin'
...
def save_results(args, test_results, debug_args = None):
    ...
    var = [args.dataset, args.backbone, args.known_cls_ratio, args.labeled_ratio, args.cluster_num_factor, args.logger_file_name, args.seed]
    names = ['dataset', 'backbone', 'known_cls_ratio', 'labeled_ratio', 'cluster_num_factor', 'logger_file_name', 'seed']
